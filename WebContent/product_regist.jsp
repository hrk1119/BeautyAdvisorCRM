			...
			<div class="col-md-10 mb-5">
				<div class="row">
					...
					<div class="col-10 mt-5 box">
						...
						<form action="./ProductRegistServlet" method="get" id="form">
							<div class="col-11 mx-auto ">
								<h2 class="ml-5">商品詳細</h2>
								<table class="table search">
									<tr>
										<th class="start">名前</th>
										<td class="start"><input type="text" name="product_name"
												class="col-8 form-control validate[required]" placeholder="">
										</td>
									</tr>
									<tr>
										<th>ブランド</th>
										<td><select name="brand" class="form-control col-8">
									...
									<tr>
										...
										<td><input type="url" name="url"
												class="col-8 form-control validate[custom[url]]"
												placeholder="xxx@cosume.jp"></td>
									</tr>
									<tr>
										<th>写真</th>
										<td><input type="text" name="group_photo"
												class="col-8 form-control"
												value="./img/products/"></td>
										<!-- <input type="file" name="group_photo" class="col-8"> -->
										</td>
									</tr>
									<tr>
										<th>商品説明</th>
										<td><textarea class="form-control col-8" rows="5" name="memo"></textarea></td>
									</tr>
									<tr>
										<th>カテゴリ</th>
							...
							<!-- カラーごとの情報 -->
							<h2 class="mt-5 ml-5">カラー詳細</h2>
							<div id="colors">
								<div>
									<p class="col-11 mx-auto my-3">1つ目</p>
									<table class="table search col-11 mx-auto product_color">
										...
										<tr>
											...
											<td><input type="text" name="color_num0"
													class="col-8 form-control validate[required]" placeholder="RD300">
											</td>
										</tr>
										<tr>
											<th>カラー名</th>
											<td><input type="text" name="color_name0"
													class="col-8 form-control validate[required]" placeholder="レッド">
											</td>
										</tr>
										<tr>
											<th>写真</th>
										...
										<tr>
											...
											<td>
												<div class="checkbox">
													...
													<label class="p"><input type="checkbox" name="pc_color0" value="2"
															class="ml-3">ブルーベース</label>
													<label class="p"><input type="checkbox" name="pc_color0" value="3"
															class="ml-3">不明</label>
												</div>
											</td>
										</tr>
							...
							<div class="col-11 mx-auto">
								<button class="btn btn-danger" id="p-btn-add">追加</button>
							</div>
							<div class="text-center">
								<input type="submit" name="sb" class="btn_pink mt-3 mb-5 px-3" value="登録する">
							</div>
						</form>
					</div>

					<div class="col-10 mt-5 box2">
						<div class="m-3">
							<p>参考サイト</p>
							<a href="https://www.cosme.net/" target="_blank">１．@cosume</a><br>
							<a href="https://www.cosme.com/" target="_blank">２．@cosume 通販サイト</a><br>
						</div>
					</div>
				</div>
			</div>
