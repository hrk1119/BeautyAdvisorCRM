...
<body>
    <div class="container-fluid customer product_edit">
        <div class="row">
                    ...
                    <div class="col-10 mt-5 box">
                        <form action="./ProductDetailServlet" method="get">
                            <div class="col-12 mt-3 mb-5 title">
                                <h1>商品情報の編集</h1>
                                <p class="mt-4 text-center">編集したい商品のJANコードを入力してください</p>
                                <input type="text" name="product_code" class="form-control col-8 mt-4 mx-auto"
