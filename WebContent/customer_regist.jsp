            ...
            <div class="col-md-10 mb-5">
                <div class="row">
                    <div class="col-10 mt-5 box">
                        ...
                        <form action="./CustomerRegistServlet" method="get" id="form">
                            <table class="table search">
                                <tr>
                                    <th class="start">名前</th>
                                    <td class="start">
                                        <input type="text" name="customer_name1"
                                            class="col-8 form-control validate[required]" placeholder="山田花子">
                                    </td>
                                </tr>
                                <tr>
                                    <th>フリガナ</th>
                                    <td>
                                        <input type="text" name="customer_name2"
                                            class="col-8 form-control validate[required]" placeholder="ヤマダハナコ">
                                    </td>
                                </tr>
                                <tr>
                                    <th>会員番号</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="radio">
                                            <label class="p"><input type="radio" name="gender" value="男性">男性</label>
                                            <label class="p"><input type="radio" name="gender" value="女性"
                                                    class="ml-3">女性</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th>電話番号</th>
                                    <td>
                                        <input type="text" name="tel" class="col-8 form-control validate[custom[phone]]"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="zip"
                                            ...
                                            class="col-8 form-control validate[required]" placeholder="例：000-0000">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="address" class="col-8 form-control"
                                            placeholder="郵便番号を入力すると自動で表示されます">
                                    </td>
                                </tr>
                                <tr>
                                    <th>職業</th>
                                    <td>
                                        <select name="work" class="form-control col-5">
                            ...
                            <div class="text-center">
                                <input type="submit" name="sb" class="btn_pink mt-3 mb-5 p-3" value="登録する">
                            </div>
                        </form>
                    </div>
