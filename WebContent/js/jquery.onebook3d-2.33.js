	...
	$.onebook = function (arrSrc, options, target) {
		...
		var OneBook3D = {
			...
			addStyle: function () {
				...
				styles += zoomTitleSpread + ' p{font:20px arial;color:black;line-height:140%;margin-bottom:10%;background-color:#f7d4c6;}\n';
				styles += zoomTitleSpread + ' p span{font:bold 20px arial;color:#464646;margin-right:8px;background-color:#f7d4c6;}\n';
				...
				styles += bookPageNumbers + '{color:#ffffff;}\n';
				styles += bookPageNumbers + '.light{color:#ffffff;}\n';
				...
				styles += bookHelpLayer + ' .hlpLeftSide p span[name=home_link]{width:36px;height:20px;margin:10px 0px 0px auto;opacity:0.8;}';
				styles += bookHelpLayer + ' .hlpLeftSide p span[name=click_to_open] a{font:21px arial;color:white;}';
				styles += bookHelpLayer + ' .hlpLeftSide p span[name=use_mousewheel]{font:12px arial;color:#ffffff;}';
				...
				styles += bookHelpLayer + ' .hlpRightSide p.middleSize span[name=goto_start] a{font:20px arial;}';
				...
				styles += bookHelpLayer + '.light .hlpLeftSide p span[name=click_to_open] a{color:#ffffff;}';
				styles += bookHelpLayer + '.light .hlpLeftSide p span[name=use_mousewheel]{color:#ffffff;}';
				styles += bookHelpLayer + '.light .hlpLeftSide p span[name=help_arrow]{opacity:0.4;}';
				styles += bookHelpLayer + '.light .hlpRightSide p span[name=goto_start] a{color:#ffffff;}';
				...
				styles += bookIconsPanel + ' ' + bookSpreadTitle + ' p{font:20px arial;color:#e58279;line-height:140%;margin-top:10%;margin-bottom:10%;background-color:#f7d4c6;border-radius:20px;}\n';
				styles += bookIconsPanel + ' ' + bookSpreadTitle + ' span{font:bold 20px arial;color:#e58279;margin-right:8px;}\n';
				styles += bookIconsPanel + '.light ' + bookSpreadTitle + ' p{color:#e58279;}\n';
				styles += bookIconsPanel + '.light ' + bookSpreadTitle + ' span{color:#e58279;}\n';
				styles += bookIconsPanel + ' .btn_title{font:12px arial;color:#e58279;padding:5px;white-space:nowrap;}\n';
			...
			changeSpreadTitle: function () {
				...
				if (first_page) {
					spreadTitle = '<p><a href="#photo-modal" onclick="myfunction(this)" data-toggle="modal" data-title="' + titles.right + '">' + titles.right + '</a></p>';
				} else if (last_page) {
					spreadTitle = '<p><a href="#photo-modal" onclick="myfunction(this)" data-toggle="modal" data-title="' + titles.left + '">' + titles.left + '</a></p>';
				} else {
					var strLeft = this.getLNG('left');
					var strRight = this.getLNG('right');
					if (titles.left && titles.right) {
						spreadTitle = [
							'<p><span>' + strLeft + ':</span> <a href="#photo-modal" onclick="myfunction(this)" data-toggle="modal" data-title="' + titles.left + '">' + titles.left + '</a><br>',
							'<span>' + strRight + ':</span> <a href="#photo-modal" onclick="myfunction(this)" data-toggle="modal" data-title="' + titles.right + '">' + titles.right + '</a></p>'
						].join('');
					} else if (titles.left) {
						spreadTitle = '<p><span>' + strLeft + ':</span>  <a href="#photo-modal" onclick="myfunction(this)" data-toggle="modal" data-title="' + titles.left + '">' + titles.left + '</a></p>';
					} else if (titles.right) {
						spreadTitle = '<p><span>' + strRight + ':</span> <a href="#photo-modal" onclick="myfunction(this)" data-toggle="modal" data-title="' + titles.right + '">' + titles.right + '</a></p>';
					};
				};
			...
			build_background: function () {
				...
				var tmpStage = [
					...
					'<div style="text-align:center;color:#ffffff;width:100%;height:100%;display:table;">',
			...
			buildSaveMenuLayer: function () {
				...
				var menuHtml = [
					...
					'<h1 style="margin:FFF 20px 10px 20px;">' + _this.getLNG('askSaveImage') + '</h1>',
