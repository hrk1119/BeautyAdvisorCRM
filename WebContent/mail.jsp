		...
		<div class="row">
			...
			<nav id="sidebar" class="col-md-2 d-none d-md-block employee">
				...
				<ul class="list-unstyled components">
					...
					<li class="active"><a class="mail_icon" href="#">メール作成</a></li>
				</ul>
			</nav>
							...
							<c:forEach var="i" begin="1" end="${page_num}" step="1">
								<div class="selection" id="page-${i}">
									<table class="result_table mb-5">
										...
										<tbody>
											<c:forEach items="${list}" var="l" begin="${data_num}" end="${i * 10}">
												<tr>
													<td>${l.productId}</td>
													...
													<td>${l.productName}</td>
													<td>${l.colorNum}</td>
													<td><input type="hidden" name="product_code" value="${l.productId}">
														<input type="submit" class="detail px-3" name="sb" value="次へ" />
													</td>
												</tr>
